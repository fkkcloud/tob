BasicGame.LevelList1 = function(game){};

BasicGame.LevelList1.prototype = {
	...
	goToNextLevel: function(){
		var me = this;
		this.game.state.start("LevelList2");
	},
	...
	createButtons: function(){
		...
		this.banner = this.game.add.sprite(this.game.world.width * (0.3333 + 0.3333 / 4), this.game.world.height * 0.9, 'nav_off');  
